...
function alDarClick (){
    ...
    etA.innerHTML = '<div class="video-contenedor"><div class="cuadro-video"><iframe width="400" height="225" src="https://www.youtube.com/embed/MJkdaVFHrto?si=3HcmXNHSRIRvOOpC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div><div class="details"><h3>Aprende HTML ahora! curso completo GRATIS desde cero</h3></div></div>';
